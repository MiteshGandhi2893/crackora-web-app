            ...
            <SwiperSlide key={i}>
              <div className="bg-white border border-[#e8e4dc] rounded-2xl p-6 flex flex-col gap-5 h-full shadow-[0_2px_16px_rgba(5,16,31,0.05)] hover:shadow-[0_6px_30px_rgba(5,16,31,0.1)] hover:border-amber-200 transition-all duration-300">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 rounded-full ${item.accent} flex items-center justify-center text-sm font-bold text-[#05101f] flex-shrink-0 font-sans`}
                  >
                    {item.initial}
                  </div>
                  <div>
                    <div className="text-[#05101f] text-sm font-semibold font-sans">
                      {item.name}
                    </div>
                    <div className="text-[#05101f]/40 text-xs font-sans">
                      {item.role}
                    </div>
                  </div>
