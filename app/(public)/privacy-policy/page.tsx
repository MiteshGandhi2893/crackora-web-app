 ...
 const sections: PageSection[] = [
  {
    ...
    subSections: [
      ...
      },
      {
        ...
        intro: "When you interact with the Platform, we may automatically collect:",
        bullets: [
  ...
  },
  {
    ...
    body:
      "We use cookies and similar technologies to remember user preferences, maintain login sessions, understand user behavior, and enhance platform performance. Users may manage or disable cookies through browser settings; however, doing so may affect certain functionalities.",
  },
  {
    number: "04",
  ...
  },
  {
    ...
    body:
      "We retain personal information only for as long as necessary to fulfill the purposes outlined in this Policy and to comply with legal, regulatory, or contractual obligations. Once no longer required, data will be securely deleted, anonymized, or archived.",
  },
  {
    number: "06",
    title: "Data Security",
    body:
      "We implement appropriate technical and organizational measures including encryption, secure communication protocols, controlled access, and protected infrastructure to safeguard your data. However, no system can guarantee absolute security, and use of the Platform is at your own risk.",
  },
  {
    number: "07",
    title: "Children's Privacy",
    body:
      "The Platform is intended for individuals aged 18 years or older. We do not knowingly collect personal data from minors. If such data is identified, appropriate steps will be taken to remove it.",
  },
  {
    number: "08",
    title: "Third-Party Links",
    body:
      "The Platform may contain links to third-party websites or services. Crackora does not control and is not responsible for their content or privacy practices. Users are encouraged to review third-party policies before sharing personal information.",
  },
  {
    number: "09",
    title: "Your Rights & Choices",
    body:
      "Depending on applicable laws, you may have the right to access, update, correct, or delete your personal data, and to opt out of marketing communications. Requests can be submitted via the contact details provided below.",
  },
  {
    number: "10",
    title: "Policy Updates",
    body:
      "This Privacy Policy may be updated periodically to reflect changes in legal, technical, or business practices. Continued use of the Platform after updates constitutes acceptance of the revised Policy.",
  },
];
  return (
    <section className="bg-[#f8f7f4] min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 pb-10">
        ...
        <p className="text-gray-600 leading-relaxed max-w-6xl text-[15px]">
         Crackora.com (“Crackora”, “we”, “us”, or “our”) is committed to safeguarding your privacy and protecting your personal information. This Privacy Policy explains how we collect, use, disclose, store, and protect your information when you access our website, mobile applications, and related services (collectively, the “Platform”).
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          {[
            ...
            <div key={b.label} className="inline-flex items-center gap-1.5 bg-white border border-gray-200 rounded-full px-3 py-1.5 shadow-sm">
              <span className="text-[10px] font-black text-amber-500">{b.icon}</span>
              <span className="text-xs font-semibold text-cyan-900">{b.label}</span>
            </div>
          ))}
        </div>
      </div>
