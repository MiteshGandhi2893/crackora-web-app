...
import type { Metadata } from "next";
 ...
 const metadata: Metadata = {
  ...
  openGraph: {
    title: "Complete MCA Journey Guide (2026)",
    description:
      "A full roadmap of MCA in India — from entrance exams to careers. Includes syllabus, timeline, and salary insights.",
    url: "https://crackora.com/tools/mca-journey",
    siteName: "Crackora",
    type: "website",
    images: [
      {
        url: "https://crackora.com/og/mca-journey.png",
        width: 1200,
        height: 630,
        alt: "Complete MCA Journey Guide",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Complete MCA Journey Guide (2026)",
    description:
      "Exams, syllabus, timeline, and career roadmap for MCA students in India.",
    images: ["https://crackora.com/og/mca-journey.png"],
  },

  alternates: {
    canonical: "https://crackora.com/tools/mca-journey",
  },
...
const WHY_POINTS = [
  {
    icon: "🎓",
    title: "UGC-recognised Master's degree",
    body: "MCA is a full postgraduate qualification. It qualifies you for government jobs, MNC campus placements, and higher studies abroad — all of which a BCA or BSc alone cannot.",
  },
  {
    icon: "💼",
    title: "Strong IT industry demand",
    body: "IT companies actively recruit MCA graduates from NITs and state universities for software development, data, and cloud roles. Your specialisation and college tier determine which companies come to campus.",
  },
  {
    icon: "📈",
    title: "Clear salary progression",
    body: "Starting salaries vary by college and skills. What matters more is the trajectory — MCA graduates who build real projects and skills consistently grow faster over 3–5 years.",
  },
  {
    icon: "🌐",
    title: "Multiple career directions",
    body: "MCA keeps you technical. You can move into software, data, cloud, security, government IT, or research — and switch paths with upskilling. It does not lock you into one track.",
  },
];
...
const MCA_SEMESTERS = [
  {
    ...
    focus:
      "Build your CS fundamentals. This is where you either fall behind or get ahead.",
  },
  {
    sem: "Semester 3 & 4",
    ...
    subjects: [
      ...
      "Elective specialisation begins",
      "Minor project",
    ],
    focus:
      "Choose your direction carefully here — Data, Web, Cloud, or Security.",
  },
  {
    sem: "Final Semester(s)",
    label: "Specialisation + Project",
    subjects: [
      "Advanced electives in chosen track",
      "Major project / dissertation",
      "Internship (most colleges)",
...
const CAREER_PATHS = [
  {
    ...
    roles: "SDE I → SDE II → Senior → Tech Lead",
    companies: "IT services, product companies, startups",
  },
  {
    path: "Data & Analytics",
    roles: "Data Analyst → Data Engineer → Data Scientist",
    companies: "Analytics, fintech, e-commerce",
  },
  {
    path: "Cloud & DevOps",
    roles: "Cloud Support → DevOps Eng → Architect",
    companies: "IT infra, consulting, cloud providers",
  },
  {
    path: "Cybersecurity",
    roles: "SOC Analyst → Pentester → Security Lead",
    companies: "BFSI, IT consulting, government",
  },
  {
    path: "Higher Studies / Research",
    roles: "MTech / MS abroad / PhD",
    companies: "Universities, research labs, academia",
  },
  {
    path: "Government IT",
    roles: "NIC / DRDO / SSC / UPSC",
...
const STATIC_TIMELINE = [
  {
    phase: "Oct – Dec",
    event: "Begin entrance exam preparation",
    type: "prep",
  },
  {
    phase: "Dec – Feb",
    event: "Application forms open for most exams",
    type: "apply",
  },
  { phase: "Mar – Jun", event: "Entrance exams conducted", type: "exam" },
  {
    phase: "Apr – Jul",
    event: "Results and rank cards released",
    type: "result",
  },
  {
    phase: "Jun – Aug",
    event: "Counselling, preferences, seat allotment",
    type: "admit",
  },
  {
    phase: "Aug – Sep",
    event: "Reporting to college — MCA begins",
    type: "college",
  },
];
...
> = {
  cyan: {
    ...
    btn: "bg-cyan-900 hover:bg-cyan-800",
  },
  amber: {
    dot: "bg-amber-500",
    ring: "ring-amber-200",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="bg-gray-50 rounded-xl p-3">
              ...
              <p className="text-xs font-semibold text-gray-800">
                Min {exam.min_pct_general}% General · {exam.min_pct_reserved}%
                Reserved
              </p>
              <p className="text-[11px] text-gray-500 mt-0.5">
                Maths:{" "}
                {exam.math_req ? exam.math_level || "Required" : "Not required"}
              </p>
              {exam.streams?.length > 0 && (
                <div className="flex flex-wrap gap-1 mt-2">
                  ...
                  {exam.streams.length > 5 && (
                    <span className="text-[10px] text-gray-400">
                      +{exam.streams.length - 5} more
                    </span>
                  )}
                </div>
              )}
            ...
            <div className="bg-gray-50 rounded-xl p-3">
              ...
              {exam.conductor && (
                <p className="text-xs text-gray-700">
                  By: <span className="font-semibold">{exam.conductor}</span>
                </p>
              )}
              {exam.reg_start && (
                <p className="text-xs text-gray-600 mt-0.5">
                  Reg opens: {exam.reg_start}
                </p>
              )}
              {exam.reg_end && (
                <p className="text-xs text-gray-600 mt-0.5">
                  Reg closes: {exam.reg_end}
                </p>
              )}
              {exam.result_date && (
                <p className="text-xs text-gray-600 mt-0.5">
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 leading-relaxed max-w-2xl">
          MCA is a 2-year postgraduate degree in computer science and software
          applications, recognised by UGC and AICTE. It is designed for students
          from non-engineering backgrounds — primarily BCA, BSc (CS/IT/Maths) —
          who want a strong technical career in software.
        </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: "Duration", value: "2 years", sub: "4 semesters" },
          {
            label: "Level",
            value: "Postgraduate",
            sub: "UGC & AICTE approved",
          },
          {
            label: "Who can apply",
            value: "BCA / BSc grads",
            sub: "+ BE / BTech eligible",
          },
        ].map((item) => (
          <div
            key={item.label}
          ...
          >
            <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-amber-600 mb-1">
              {item.label}
            </p>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5">
        <p className="text-xs font-bold tracking-[0.15em] uppercase text-amber-600 mb-3">
          MCA vs MBA vs MTech
        </p>
          ...
          {[
            {
              name: "MCA",
              focus: "Software & tech",
              path: "IT, product, government",
            },
            {
              name: "MBA",
              focus: "Management & biz",
              path: "Consulting, BFSI, ops",
            },
            {
              name: "MTech",
              focus: "Core engineering",
              path: "R&D, PSU, academia",
            },
          ].map((item) => (
            <div
              key={item.name}
              className={`rounded-xl p-3 border-2 ${item.name === "MCA" ? "bg-amber-50 border-amber-300" : "bg-gray-50 border-gray-100"}`}
            >
              <p
                className={`text-base font-extrabold mb-1 ${item.name === "MCA" ? "text-amber-700" : "text-gray-400"}`}
              >
                {item.name}
              </p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-gray-600 max-w-2xl">
          MCA makes sense for specific students. Here is an honest breakdown —
          why it is worth it, and for whom.
        </p>
      </div>
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <div className="h-0.5 w-12 bg-amber-500 mb-3" />
        <p className="text-gray-600 max-w-2xl">
          MCA admissions happen through national, state, and university-level
          entrance exams. Most students apply to 2–3 exams to maximise college
          options. Click any exam to see details.
        </p>
      </div>
        ...
        <div className="flex flex-col gap-3">
          {exams.map((exam) => (
            <ExamCard
              ...
              onToggle={() =>
                setExpandedId(expandedId === exam.exam_id ? null : exam.exam_id)
              }
            />
          ))}
        </div>
      ...
      <div className="bg-cyan-900 rounded-2xl p-5">
        <p className="text-xs font-bold tracking-[0.2em] uppercase text-amber-400 mb-2">
          Which exams should you apply for?
        </p>
        <p className="text-[13px] text-cyan-300 leading-relaxed mb-3">
          Maharashtra students must take MAH MCA CET for state college
          admissions. For NITs, NIMCET is the only route. CUET PG covers central
          universities. State exams like TANCET and WB JECA cover good regional
          colleges. Apply to at least 2–3 exams every cycle.
        </p>
...
function TimelinePanel({
  ...
  const liveEvents = exams
    ...
    .map((e) => ({
      exam: e.short_name,
      date: e.rule_exam_date || e.config_exam_date,
      color: e.color,
      bg: e.bg_color,
    }));
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <div className="h-0.5 w-12 bg-amber-500 mb-3" />
        <p className="text-gray-600 max-w-2xl">
          The full admission cycle runs from October to September. Here is the
          typical sequence — exact dates vary by exam and year. Do not wait for
          one result before applying elsewhere.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        {STATIC_TIMELINE.map((item, i) => (
          <div
            key={i}
            className={`flex items-center gap-4 p-3.5 rounded-xl border-2 ${TIMELINE_STYLES[item.type]}`}
          >
            <span className="text-[11px] font-bold w-20 shrink-0">
              {item.phase}
            </span>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {liveEvents.map((ev) => (
              ...
              >
                <span
                  className="text-xs font-bold px-2 py-0.5 rounded-lg bg-white"
      ...
      <div className="bg-white border-2 border-amber-200 rounded-2xl p-5">
        ...
        <p className="text-[13px] text-gray-600 leading-relaxed">
          ...
          Application windows overlap heavily. Having everything prepared means
          you can apply to multiple exams in one sitting.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <div className="h-0.5 w-12 bg-amber-500 mb-3" />
        <p className="text-gray-600 max-w-2xl">
          Here is what the 2-year MCA programme typically looks like. The exact
          syllabus varies by university — but the structure below is broadly
          common.
        </p>
      </div>
          ...
          >
            <div className="flex items-center gap-4 p-4">
              ...
              <div className="flex-1">
                ...
                <p
                  className={`text-xs font-semibold mt-0.5 ${openSem === i ? "text-purple-600" : "text-gray-400"}`}
                >
                  {sem.label}
                </p>
              </div>
              <svg
                className={`w-4 h-4 text-gray-400 transition-transform ${openSem === i ? "rotate-180" : ""}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-center">
          {[
            { rank: "#1", item: "Projects", sub: "1–2 strong GitHub projects" },
            {
              rank: "#2",
              item: "Internship",
              sub: "Even 1 internship changes outcomes",
            },
            {
              rank: "#3",
              item: "DSA / CP",
              sub: "LeetCode, competitive programming",
            },
          ].map((item) => (
            <div
              key={item.rank}
              className="bg-cyan-50 border border-cyan-100 rounded-xl p-3"
            >
              <p className="text-xl font-black text-amber-500 mb-1">
                {item.rank}
              </p>
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <div className="h-0.5 w-12 bg-amber-500 mb-3" />
        <p className="text-gray-600 max-w-2xl">
          After MCA you have multiple directions. Software development is most
          common, but data, cloud, security, government IT, and higher studies
          are all real and viable paths.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        {CAREER_PATHS.map((cp) => (
          ...
          >
            ...
            <p className="text-[11px] text-gray-400 shrink-0 sm:text-right">
              {cp.companies}
            </p>
          </div>
        ))}
      ...
      {!loading && salary.length > 0 && (
        <div>
                ...
                <div className="space-y-1.5">
                  {[
                    ...
                    >
                      ...
                      <span
                        className={`text-xs font-bold font-mono ${row.color}`}
                      >
                        {row.val}
                      </span>
                    </div>
          ...
          <p className="text-[11px] text-gray-400 mt-2">
            Ranges shown for the top college tier. Private college outcomes are
            lower. Individual results depend on skills, projects, and location.
          </p>
        </div>
      )}
          ...
          {STAGES.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <p
                    className={`text-sm font-bold ${active ? c.text : done ? "text-gray-600" : "text-gray-400"}`}
                  >
                    {s.label}
                  </p>
                ...
                {active && (
                  <span
                    className={`text-[10px] font-black px-2 py-0.5 rounded-full ${c.bg} ${c.text} border ${c.border}`}
                  >
                    Current
                  </span>
                )}
    ...
    <main className="min-h-screen bg-[#f8f7f4]">
      ...
      <div className="bg-cyan-950 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8 py-16 sm:py-20 z-10">
          <div
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-500/30
          ...
          <h1 className="text-3xl sm:text-5xl font-bold text-white leading-tight mb-3">
            The Complete <span className="text-amber-400">MCA Journey</span>
          </h1>
          <div className="h-0.5 w-16 bg-amber-500 mb-4" />
          <p className="text-white/50 text-sm max-w-xl leading-relaxed">
            6 stages from eligibility check to career — honest, practical, and
            backed by real data.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-8 py-4">
          ...
          <div className="flex sm:hidden items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center text-base ${c.dot} text-white`}
              >
                {stage.icon}
              </div>
              <div>
          ...
          <div className="hidden sm:flex items-center justify-between mt-3">
            <div className="flex items-center gap-2">
              <span
                className={`text-xs font-bold px-2.5 py-0.5 rounded-full border ${c.bg} ${c.text} ${c.border}`}
              >
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8 py-8">
        ...
        <div className={`rounded-2xl border-2 p-5 mb-7 ${c.bg} ${c.border}`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p
                  className={`text-[10px] font-bold uppercase tracking-[0.2em] ${c.text} opacity-60`}
                >
                  {stage.phase}
                </p>
            ...
            <span
              className={`text-[10px] font-bold px-2.5 py-1 rounded-full bg-white/60 ${c.text}`}
            >
        ...
        {stage.id === "timeline" && (
          <TimelinePanel exams={exams} loading={loading} />
        )}
        {stage.id === "mca-life" && <McaLifePanel />}
        {stage.id === "career" && (
          <CareerPanel salary={salary} loading={loading} />
        )}
